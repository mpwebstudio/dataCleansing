...
dataCleansingApp.controller('TelephoneCleansingController',
    function TeelephoneCleansingController($scope, $http, Upload) {
        ...
        $scope.uploadFile = function () {
            ...
            var uploadUrl = '/PhoneCleansing/GetData';
            ...
            .success(function (data, status, headers, config) {
                ...
                $(document).ready(function () {
                    ...
                    var hot = new Handsontable(container, {
                        data: data,
                        height: 396,
                        colHeaders: ["Number", "Is Valid?", "Area", "Message"],
                        rowHeaders: true,
                        stretchH: 'all',
                        columnSorting: true,
                        contextMenu: true
