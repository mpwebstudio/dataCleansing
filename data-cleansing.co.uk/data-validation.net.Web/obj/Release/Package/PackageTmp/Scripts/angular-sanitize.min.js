...
*/
(function (y, f, z) {
    'use strict'; function A(a) { var d = []; t(d, f.noop).chars(a); return d.join("") } function g(a, d) { var b = {}, c = a.split(","), k; for (k = 0; k < c.length; k++) b[d ? f.lowercase(c[k]) : c[k]] = !0; return b } function B(a, d) {
        null === a || a === z ? a = "" : "string" !== typeof a && (a = "" + a); e.innerHTML = a; var b = 5; do { if (0 === b) throw u("uinput"); b--; 11 >= document.documentMode && n(e); a = e.innerHTML; e.innerHTML = a } while (a !== e.innerHTML); for (b = e.firstChild; b;) {
            switch (b.nodeType) {
                case 1: d.start(b.nodeName.toLowerCase(), C(b.attributes));
                    break; case 3: d.chars(b.textContent)
            } var c; if (!(c = b.firstChild) && (1 == b.nodeType && d.end(b.nodeName.toLowerCase()), c = b.nextSibling, !c)) for (; null == c;) { b = b.parentNode; if (b === e) break; c = b.nextSibling; 1 == b.nodeType && d.end(b.nodeName.toLowerCase()) } b = c
        } for (; b = e.firstChild;) e.removeChild(b)
    } function C(a) { for (var d = {}, b = 0, c = a.length; b < c; b++) { var k = a[b]; d[k.name] = k.value } return d } function v(a) {
        ...
        var b = !1, c = f.bind(a, a.push); return {
            start: function (a, e) { a = f.lowercase(a); !b && G[a] && (b = a); b || !0 !== r[a] || (c("<"), c(a), f.forEach(e, function (b, e) { var g = f.lowercase(e), F = "img" === a && "src" === g || "background" === g; !0 !== H[g] || !0 === w[g] && !d(b, F) || (c(" "), c(e), c('="'), c(v(b)), c('"')) }), c(">")) }, end: function (a) {
                a = f.lowercase(a); b || !0 !== r[a] || !0 === x[a] || (c("</"), c(a), c(">")); a ==
                b && (b = !1)
    ...
    !0), H = f.extend({}, w, m, s), e; (function (a) { if (a.document && a.document.implementation) a = a.document.implementation.createHTMLDocument("inert"); else throw u("noinert"); var d = (a.documentElement || a.getDocumentElement()).getElementsByTagName("body"); 1 === d.length ? e = d[0] : (d = a.createElement("html"), e = a.createElement("body"), d.appendChild(e), a.appendChild(d)) })(y); f.module("ngSanitize", []).provider("$sanitize", function () {
        var a = !1; this.$get = ["$$sanitizeUri", function (d) {
            a && f.extend(r, I); return function (a) {
                var c =
                []; B(a, t(c, function (a, b) { return !/^unsafe:/.test(d(a, b)) })); return c.join("")
            }
        }]; this.enableSvg = function (d) { return f.isDefined(d) ? (a = d, this) : a }
    }); f.module("ngSanitize").filter("linky", ["$sanitize", function (a) {
        var d = /((ftp|https?):\/\/|(www\.)|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"\u201d\u2019]/i, b = /^mailto:/i; return function (c, e) {
            function g(a) { a && p.push(A(a)) } function m(a, b) { p.push("<a "); f.isDefined(e) && p.push('target="', e, '" '); p.push('href="', a.replace(/"/g, "&quot;"), '">'); g(b); p.push("</a>") }
            if (!c) return c; for (var l, q = c, p = [], h, n; l = q.match(d) ;) h = l[0], l[2] || l[4] || (h = (l[3] ? "http://" : "mailto:") + h), n = l.index, g(q.substr(0, n)), m(h, l[0].replace(b, "")), q = q.substring(n + l[0].length); g(q); return a(p.join(""))
        }
    }])
