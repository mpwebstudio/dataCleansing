...
dataCleansingApp.controller('AddressCleansingController',
    function AddressCleansingController($scope, $http,Upload) {
        ...
        dropbox.addEventListener("dragover", function (evt) {
            ...
            $scope.$apply(function () {
                $scope.dropText = ok ? 'Drop a CSV file here...' : 'Only files are allowed!'
        ...
        $scope.uploadFile = function () {
            ...
            var uploadUrl = '/AddressCleansing/GetData/';
            ...
            .success(function (data, status, headers, config) {
                ...
                $(document).ready(function () {
                    ...
                    var hot = new Handsontable(container, {
                        data: data,
                        height: 396,
                        colHeaders: ["Building Name", "Flat", "Number", "Street", "Locality", "Traditional County","Postcode"],
                        rowHeaders: true,
                        stretchH: 'all',
                        columnSorting: true,
                        contextMenu: true
